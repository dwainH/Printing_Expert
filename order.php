...
<nav class="navbar navbar-light navbar-expand-md py-3">
    ...
    <div class="container py-4 py-xl-5">
        ...
        <div data-aos="flip-left" data-aos-delay="500" data-aos-duration="1000" class="row gy-4 gy-xl-0 row-cols-1 row-cols-md-2 row-cols-xl-3 d-xl-flex align-items-xl-center gutter-y" >
            <div class="col">
                <div class="card">
