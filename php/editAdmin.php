...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="login.php" data-target="#collapseEmployee"
                    aria-expanded="true" aria-controls="collapseEmployee">
...
<!---------------------------------------------------------------------------------------------------------------------->
                ...
                <div class="container-fluid">
                    ...
                    <?php  
                        ...
                        {
                            $admin_id = $_GET['id'];
                            $admin = "SELECT * FROM admin WHERE id='$admin_id' ";
                            ...
                            if(mysqli_num_rows($admin_run)>0)
                            {
                                ...
                                <div class="card shadow mb-4 border-primary rounded-4">
                                    ...
                                    <br><h1 class="h3 mb-2 text-gray-800 text-center text-sm-start text-uppercase">
                                        <b>Update Admin Details</b></h1><br>
                                            ...
                                            <input type="hidden" name="id" value="<?=$admin['id'];?>">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        aria-label="First name" name="firstName" value="<?=$admin['firstname'];?>">
                                                    </div>
                                                    <div class="col">
                                                    <input required  type="text" class="form-control" placeholder="Last name" 
                                                    aria-label="Last name" name="lastName" value="<?=$admin['lastname'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    id="inputEmail" name="email" value="<?=$admin['email'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    id="inputPhoneNum" name="phoneNumber" value="<?=$admin['phoneNumber'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    id="inputUsername" name="username" value="<?=$admin['username'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <br>
                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                        <a class="btn btn-primary me-md-2"  href="dashboard.php" role="button">Back</a>

                                                        <!-- Button trigger modal -->
                                                        <button type="submit" name="editAdmin_btn" onclick="checker()"
...
<!---------------------------------------------------------------------------------------------------------------------->
    ...
    <script>
        function checker(){
            var result = confirm("Edit Admin Profile?");
            if(result == false){
