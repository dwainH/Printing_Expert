                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 border-primary rounded-4">
                        <div class="card-body ">
                            ...
                            id="adminTable" width="100%" cellspacing="0">
                                <thead>
                                    <h1 class="h3 mb-4 text-gray-800 text-center text-sm-start text-uppercase">
                                        <b>Admin Profile</b></h1>
                                </thead>
                                <!-- select the data from admin table in database -->
                                <?php
                                    include('dbconn.php');
                                    ...
                                    ?>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">Admin ID: </label>
                                        <?php echo $d['id']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">First Name: </label>
                                        <?php echo $d['firstname']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">Last Name: </label>
                                        <?php echo $d['lastname']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">Email: </label>
                                        <?php echo $d['email']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">Phone Number (60+): </label>
                                        <?php echo $d['phoneNumber']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">Username: </label>
                                        <?php echo $d['username']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><label for="inputName" class="col-sm-2 col-form-label">Password: </label>
                                        <?php echo $d['password']; ?></th>
                                    </tr>
                            </table>
                                <tr>
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        ...
                                        <a href="editAdmin.php?id=<?php echo $d['id']; ?>" name="editAdmin_btn" 
