            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800 text-sm-start text-uppercase">
                        <b>Yearly Sales Report</b></h2>

                    <!-- Display Yearly Sales Report (Graph) Card -->
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- custom card border and width-->
                            <div class="card border-primary text-bg-light mb-3 w-auto p-3">
                                <div class="card-header bg">
                                    <h5 class="card-title font-weight-bold text-uppercase">Yearly Sales Report</h5>
                                </div>
                                <div class="card-body">
                                    <!-- Create bar chart -->
                                        <div class="box">
