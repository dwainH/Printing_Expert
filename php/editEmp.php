...
<!---------------------------------------------------------------------------------------------------------------------->
                ...
                <div class="container-fluid">
                    ...
                    <?php  
                        ...
                        {
                            $employee_id = $_GET['id'];
                            $employee = "SELECT * FROM employee WHERE id='$employee_id' ";
                            $employee_run = mysqli_query($conn, $employee);

                            if(mysqli_num_rows($employee_run)>0)
                            {
                                foreach($employee_run as $employee)
                                {
                                ?>
                                ...
                                <div class="card shadow mb-4 border-primary rounded-4">
                                    ...
                                    <br><h1 class="h3 mb-2 text-gray-800 text-center text-sm-start text-uppercase">
                                        <b>Update Employee Details</b></h1><br>
                                            ...
                                            <input type="hidden" name="id" value="<?=$employee['id'];?>">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        aria-label="First name" name="firstName" value="<?=$employee['firstName'];?>">
                                                    </div>
                                                    <div class="col">
                                                    <input required  type="text" class="form-control" placeholder="Last name" 
                                                    aria-label="Last name" name="lastName" value="<?=$employee['lastName'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                                                    <div class="col-sm-10">
                                                    <input required type="email" class="form-control" placeholder="Abc123@gmail.com" 
                                                    id="inputEmail" name="email" value="<?=$employee['email'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="inputPhoneNum" class="col-sm-2 col-form-label">Phone Number (60+)</label>
                                                    <div class="col-sm-10">
                                                    <input required type="phoneNum" class="form-control" placeholder="17888999" 
                                                    id="inputPhoneNum" name="phoneNumber" value="<?=$employee['phoneNumber'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="inputUsername" class="col-sm-2 col-form-label">Username</label>
                                                    <div class="col-sm-10">
                                                    <input required type="username" class="form-control" placeholder="Abc123" 
                                                    id="inputUsername" name="username" value="<?=$employee['username'];?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <select required class="form-control" id="role" name="role">
                                                        ...
                                                        <option value="Senior" name="role" <?= $employee['role'] == 'Senior' ? 'selected':'' ?>>Senior</option>
                                                        <option  value="Junior" name="role" <?= $employee['role'] == 'Junior' ? 'selected':'' ?>>Junior</option>
                                                    </select>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <input type="hidden" name="adminId" value="<?=$employee['adminId']='1';?>">
                                                    </div>
                                                </div>
                                                <tr>
                                                <br>
                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                        ...
                                                        <button type="submit" name="editEmp_btn" onclick="checker()" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title fs-5" id="ModalLabel">Continue change the data?</h5>
                                                        
                                                        </div>
                                                        <div class="modal-body">
                                                            Select "Save Changes" below if you want to save any changes.
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                            <a class="btn btn-primary" href="addEmp.php" role="button">Save Changes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!---------------------------------------------------------------------------------------------------------------------->
    ...
    <script>
        function checker(){
            var result = confirm("Edit Employee?");
            if(result == false){
