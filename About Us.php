...
<nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.php"><span class="d-flex justify-content-center align-items-center bs-icon-sm bs-icon-rounded bs-icon-primary me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewbox="0 0 16 16" class="bi bi-bezier"><path fill-rule="evenodd" d="M0 10.5A1.5 1.5 0 0 1 1.5 9h1A1.5 1.5 0 0 1 4 10.5v1A1.5 1.5 0 0 1 2.5 13h-1A1.5 1.5 0 0 1 0 11.5v-1zm1.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zm10.5.5A1.5 1.5 0 0 1 13.5 9h1a1.5 1.5 0 0 1 1.5 1.5v1a1.5 1.5 0 0 1-1.5 1.5h-1a1.5 1.5 0 0 1-1.5-1.5v-1zm1.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zM6 4.5A1.5 1.5 0 0 1 7.5 3h1A1.5 1.5 0 0 1 10 4.5v1A1.5 1.5 0 0 1 8.5 7h-1A1.5 1.5 0 0 1 6 5.5v-1zM7.5 4a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1z"></path><path d="M6 4.5H1.866a1 1 0 1 0 0 1h2.668A6.517 6.517 0 0 0 1.814 9H2.5c.123 0 .244.015.358.043a5.517 5.517 0 0 1 3.185-3.185A1.503 1.503 0 0 1 6 5.5v-1zm3.957 1.358A1.5 1.5 0 0 0 10 5.5v-1h4.134a1 1 0 1 1 0 1h-2.668a6.517 6.517 0 0 1 2.72 3.5H13.5c-.123 0-.243.015-.358.043a5.517 5.517 0 0 0-3.185-3.185z"></path></svg></span><span><b>Printing</b><b> Expert</b></span></a><button data-bs-toggle="collapse" data-bs-target="#navcol-1" class="navbar-toggler"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php else: echo '</ul><a class="btn btn-primary" href="login.php" role="button" id="myButton">Login</a>'?>
                <?php endif ?>
            </div>
        </div>
    </nav>
    <div class="container py-4 py-xl-5" data-aos="flip-left" data-aos-delay="500" data-aos-duration="1000">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2>Why Pick Us?</h2>
                <p class="w-lg-50">Want an affordable service together with high quality materials?</p>
            </div>
        </div>
        <div class="row gy-4 row-cols-1 row-cols-md-2">
            <div class="col">
                <div class="d-flex flex-column flex-lg-row">
                    <div class="w-100"><img class="rounded img-fluid d-block w-100 fit-cover" style="height:200px;" src="assets/img/paper%20factory.jpg"></div>
                    <div class="py-4 py-lg-0 px-lg-4">
                        <h4>Expert manufacturing</h4>
                        <p>Enjoy high-quality posters that were manufactured using the latest technology by the experts in the field.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex flex-column flex-lg-row">
                    <div class="w-100"><img class="rounded img-fluid d-block w-100 fit-cover" style="height:200px;" src="assets/img/poster%20material.jpg"></div>
                    <div class="py-4 py-lg-0 px-lg-4">
                        <h4>High Quality material</h4>
                        <p>The highest quality material imported from all around the world</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex flex-column flex-lg-row">
                    <div class="w-100"><img class="rounded img-fluid d-block w-100 fit-cover" style="height:200px;" src="assets/img/price%20vs%20value.jpg" width="333" height="200"></div>
                    <div class="py-4 py-lg-0 px-lg-4">
                        <h4>Appropriate Prices</h4>
                        <p>Prices that make sense!</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex flex-column flex-lg-row">
                    <div class="w-100"><img class="rounded img-fluid d-block w-100 fit-cover" style="height:200px;" src="assets/img/Global%20shipping.jpg"></div>
                    <div class="py-4 py-lg-0 px-lg-4">
                        <h4>Global Shipping</h4>
                        <p>Want to order posters but not in Malaysia? Don't worry we got you covered!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        <h4 class="text-center">Still Having Doubts?</h4>
        <p class="text-center">Check out on the verified stats!</p>
    </div>
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 row-cols-2 row-cols-md-4" style="background:#ffffff;border-radius:19px;border:1px solid var(--bs-blue);">
            <div class="col" id="row-1">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                    <div class="d-flex flex-shrink-0 justify-content-center align-items-center bs-icon-xl bs-icon-circle bs-icon-primary d-inline-block mb-2 bs-icon lg"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bell">
                            <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"></path>
                        </svg></div>
                    <div class="px-3">
                        <h2 class="fw-bold mb-0">1000+</h2>
                        <p class="mb-0">Ongoing orders</p>
                    </div>
                </div>
            </div>
            <div class="col-md-5" id="row-2" style="height:214.396px;">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3" style="width:356.656px;height:238.396px;">
                    <div class="d-flex flex-shrink-0 justify-content-center align-items-center bs-icon-xl bs-icon-circle bs-icon-primary d-inline-block mb-2 bs-icon lg"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    <div class="px-3">
                        ...
                        <p class="mb-0">Ships in 12 Different Countries</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3" id="row-3" style="padding:0px 13px;width:232.5px;">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3" style="width:103.5px;">
                    <div class="d-flex flex-shrink-0 justify-content-center align-items-center bs-icon-xl bs-icon-circle bs-icon-primary d-inline-block mb-2 bs-icon lg"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart2">
